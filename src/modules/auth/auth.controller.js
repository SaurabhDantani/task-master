...
var AuthController = function () {
    ...
    (function () {
        ...
        _register_decorators = [(0, common_1.Post)('register'), (0, common_1.HttpCode)(common_1.HttpStatus.CREATED), (0, swagger_1.ApiOperation)({ summary: 'Register a new user' }), (0, swagger_1.ApiResponse)({ status: 201, description: 'User successfully registered' }), (0, swagger_1.ApiResponse)({ status: 409, description: 'Email already exists' })];
        _login_decorators = [(0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Login and receive access token' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Login successful, token returned' }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid credentials' })];
