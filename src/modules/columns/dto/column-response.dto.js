...
exports.ColumnResponseDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var ColumnResponseDto = function () {
    var _a;
    var _id_decorators;
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _id_decorators = [(0, swagger_1.ApiProperty)({ example: 'column-uuid-1234' })];
            _name_decorators = [(0, swagger_1.ApiProperty)({ example: 'Todo' })];
            _boardId_decorators = [(0, swagger_1.ApiProperty)({ example: 'board-uuid-1234' })];
            _position_decorators = [(0, swagger_1.ApiProperty)({ example: 1 })];
...
exports.ColumnResponseDto = ColumnResponseDto;
