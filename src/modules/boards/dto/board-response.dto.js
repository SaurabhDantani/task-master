...
exports.BoardResponseDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var BoardResponseDto = function () {
    var _a;
    var _id_decorators;
    ...
    return _a = /** @class */ (function () {
            function BoardResponseDto() {
                ...
                this.createdAt = (__runInitializers(this, _projectId_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
        ...
        (function () {
            ...
            _id_decorators = [(0, swagger_1.ApiProperty)({ example: 'board-uuid-1234' })];
            _name_decorators = [(0, swagger_1.ApiProperty)({ example: 'Development Board' })];
            _projectId_decorators = [(0, swagger_1.ApiProperty)({ example: 'project-uuid-1234' })];
