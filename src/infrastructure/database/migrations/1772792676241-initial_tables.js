...
exports.InitialTables1772792676241 = void 0;
var InitialTables1772792676241 = /** @class */ (function () {
    function InitialTables1772792676241() {
        this.name = 'InitialTables1772792676241';
    }
    InitialTables1772792676241.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"project_members\" (\"id\" uuid NOT NULL DEFAULT uuid_generate_v4(), \"projectId\" character varying NOT NULL, \"userId\" character varying NOT NULL, \"role\" character varying NOT NULL DEFAULT 'member', \"joinedAt\" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT \"PK_0b2f46f804be4aea9234c78bcc9\" PRIMARY KEY (\"id\"))")];
                    case 3:
                        _a.sent();
                    ...
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"comments\" (\"id\" uuid NOT NULL DEFAULT uuid_generate_v4(), \"taskId\" character varying NOT NULL, \"userId\" character varying NOT NULL, \"content\" text NOT NULL, \"createdAt\" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT \"PK_8bf68bc960f2b69e818bdb90dcb\" PRIMARY KEY (\"id\"))")];
                    case 5:
                        _a.sent();
    ...
    InitialTables1772792676241.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("DROP TABLE \"boards\"")];
                    case 1:
                        _a.sent();
    ...
    return InitialTables1772792676241;
}());
exports.InitialTables1772792676241 = InitialTables1772792676241;
