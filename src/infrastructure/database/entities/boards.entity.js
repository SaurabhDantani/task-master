...
var Board = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('boards')];
    ...
    var Board = _classThis = /** @class */ (function () {
        function Board_1() {
    ...
    __setFunctionName(_classThis, "Board");
    (function () {
        ...
        Board = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Board = _classThis;
}();
exports.Board = Board;
