...
var ColumnEntity = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('columns')];
    ...
    var ColumnEntity = _classThis = /** @class */ (function () {
        function ColumnEntity_1() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.boardId = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _boardId_initializers, void 0));
            this.name = (__runInitializers(this, _boardId_extraInitializers), __runInitializers(this, _name_initializers, void 0));
        ...
        return ColumnEntity_1;
    }());
    __setFunctionName(_classThis, "ColumnEntity");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('uuid')];
        _boardId_decorators = [(0, typeorm_1.Column)()];
        ...
        ColumnEntity = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ColumnEntity = _classThis;
}();
