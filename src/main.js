...
var all_exceptions_filter_js_1 = require("./common/filters/all-exceptions.filter.js");
var transform_interceptor_js_1 = require("./common/interceptors/transform.interceptor.js");
var swagger_1 = require("@nestjs/swagger");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, logger, config, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    logger.log("\uD83D\uDE80 Task Master is running on: http://localhost:".concat(port, "/api/v1"));
                    logger.log("\uD83D\uDCDA Swagger documentation is available at: http://localhost:".concat(port, "/api/docs"));
                    return [2 /*return*/];
            }
        });
    });
